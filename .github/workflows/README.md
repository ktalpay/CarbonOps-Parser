...
parser fixture dry-run behavior, .NET contract tests, parity fixture presence,
sample config safety, runbook consistency, and whitespace cleanliness.

The full Python test suite and full repository public-safety validation are
intentionally outside the default release gate. They remain separate tracked
