"""Runtime-passive DEFRA/DESNZ parser adapter skeleton contract."""
...
@dataclass(frozen=True)
class DefraDesnzParserAdapterDescriptor:
    """Runtime-passive DEFRA/DESNZ parser adapter skeleton descriptor."""
...
def describe_defra_desnz_parser_adapter() -> DefraDesnzParserAdapterDescriptor:
    """Return deterministic DEFRA/DESNZ parser adapter skeleton metadata only."""
    ...
    return DefraDesnzParserAdapterDescriptor(
        source_family=DEFRA_DESNZ_SOURCE_FAMILY,
        parser_key=DEFRA_DESNZ_PARSER_KEY,
