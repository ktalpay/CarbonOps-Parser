...
`NormalizationInput` provides the next boundary shape for ready handoffs with raw payloads. It preserves raw parser fields for future normalization without transforming values.
