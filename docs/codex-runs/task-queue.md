...
- CO-024A: Add local public safety validation script.

## Next

- CO-024B: Add source adapter public API reference documentation.

## Backlog

- CO-025A: Add local adapter edge-case documentation.
